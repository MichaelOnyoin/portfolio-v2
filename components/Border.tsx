...
<div className="bg-gray-950 px-8 py-16">
  <div className="mx-auto flex max-w-md flex-col gap-y-10">
    <div className="rounded-(--card-radius) bg-white/15 p-(--card-padding) outline -outline-offset-1 outline-white/25 [--card-padding:--spacing(3)] [--card-radius:var(--radius-4xl)]">
      <img className="aspect-5/6 rounded-[calc(var(--card-radius)-var(--card-padding))] bg-gray-800 object-cover shadow-2xl outline -outline-offset-1 outline-white/10" src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2102&q=80" alt="" />
    </div>
    <figure className="relative isolate pt-6">
      <svg viewBox="0 0 162 128" fill="none" aria-hidden="true" className="absolute top-0 left-0 -z-10 h-32 stroke-white/20">
